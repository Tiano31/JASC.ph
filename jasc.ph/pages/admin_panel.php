...
<body class="profile-page sidebar-collapse">
    ...
    <!-- End Navbar -->
        ...
        <div class="wrapper">
            <div class="page-header page-header-small" filter-color="none">
            <div class="page-header-image" data-parallax="true" style="background-image: url('../uploads/jasc.jpg');"></div>
                <div class="container">
        ...
        <div class="section">
            <div class="container">
                <div class="button-container">
                    ...
                    <a href="https://twitter.com/Itchanooo_" target="_blank" class="btn btn-default btn-round btn-lg btn-icon" rel="tooltip" title="Follow me on Twitter">
                        <i class="fa fa-twitter"></i>
                    </a>
                    <a href="https://www.facebook.com/christian.villaveza/" target="_blank" class="btn btn-default btn-round btn-lg btn-icon" rel="tooltip" title="Follow me on Facebook">
                        <i class="fa fa-facebook"></i>
                    </a>
                    <a href="https://www.instagram.com/itchanoo_/" target="_blank" class="btn btn-default btn-round btn-lg btn-icon" rel="tooltip" title="Follow me on Instagram">
                        <i class="fa fa-instagram"></i>
                    </a>
                </div>
               <div class="row">

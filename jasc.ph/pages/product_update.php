...
{   
    ...
    $prod_color = mysqli_real_escape_string($dbconn, $_POST['prod_color']);
    ...
    if(empty($prod_name) || empty($prod_color) ||empty($prod_desc) || empty($prod_cost) || empty($prod_price) || empty($category) || empty($prod_serial)) {    
        ...
        //updating the table
        $query = "UPDATE products SET prod_name='$prod_name',prod_color='$prod_color',prod_desc='$prod_desc',prod_cost='$prod_cost',prod_price='$prod_price',
  ...
  <div class="panel-body">
    <form action="product_update.php" method="post">
        <div class="form group">
            ...
            <label for="prod_id">ID Number:</label>
            ...
            <input type="text" class="form-control" id="prod_color" name="prod_color" value="<?php echo $prod_color;?>">

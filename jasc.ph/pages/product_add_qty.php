  ...
  <div class="panel-body">
    <form action="product_add_qty.php" method="post">
        <div class="form group">
            ...
            <label for="prod_serial">Product ID Number: &nbsp <?php echo $prod_serial;?></label><br><br>
            <label for="prod_name">Product Name: &nbsp <?php echo $prod_name;?></label><br><br>
            <label for="prod_color">Product Color: &nbsp <?php echo $prod_color;?></label><br><br>
            <label for="prod_desc">Description: &nbsp <?php echo $prod_desc;?></label><br><br>
            <label for="prod_price">Product Cost (Php): &nbsp <?php echo $prod_price;?></label><br><br>
            <label for="category">Product Category: &nbsp <?php echo $category;?></label><br><br>
            <label for="qty">Available Quantity: &nbsp <?php echo $prod_qty;?></label><br><br>

...
if(isset($_POST['submit'])){
    ...
    if(empty($prod_name) || empty($prod_color) ||empty($prod_desc) || empty($prod_qty) || empty($prod_cost) || empty($prod_price) || empty($category) 
        ...
        if(empty($prod_name)) {
            echo "<font color='red'>Product name field is empty!</font><br/>";
                ...
                if(empty($prod_color)) {
            echo "<font color='red'>Product color field is empty!</font><br/>";
        }
        ...
        $query = "INSERT INTO products (prod_name, prod_color, prod_desc, prod_qty, prod_cost, prod_price, category, prod_serial, prod_pic1, prod_pic2, prod_pic3) 
        VALUES ('$prod_name','$prod_color','$prod_desc','$prod_qty','$prod_cost','$prod_price','$category','$prod_serial','$prod_pic1','$prod_pic2','$prod_pic3')";  
          ...
          <div class="panel-body">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form group">
                    ...
                    <input type="text" class="form-control" id="prod_color" name="prod_color" placeholder="Product Color"/>
                    ...
                    <label for="prod_serial">ID Number:</label>
